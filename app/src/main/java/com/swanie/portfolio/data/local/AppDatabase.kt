...
@Database(
    ...
    // 🛡️ V12 RECOVERY HINT: adds passwordHint to user profile
    version = 12,
    exportSchema = false
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        const val DB_NAME = "swanie_vault_v12_recovery"
        @Volatile
                    ...
                    .addCallback(object : RoomDatabase.Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                ...
                                db.execSQL("INSERT INTO user_profile (id, userName, displayName, email, loginPassword, passwordHint, hasAcceptedTOS, subscriptionTier, languageCode, preferredWeightUnit) VALUES (1, '', '', '', '', '', 0, 0, 'en', 'OZ')")
