...
class PortfolioWidget : GlanceAppWidget() {
    ...
    interface PortfolioWidgetEntryPoint {
        ...
        fun userConfigDao(): com.swanie.portfolio.data.local.UserConfigDao
        fun priceHistoryDao(): com.swanie.portfolio.data.local.PriceHistoryDao
        fun assetDao(): com.swanie.portfolio.data.local.AssetDao
        fun themePreferences(): com.swanie.portfolio.data.ThemePreferences
    }
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        allVaultAssets.forEach { asset ->
            val multiplier = if (asset.name.contains("KILO", true)) 32.1507 else if (asset.name.contains("GRAM", true)) 0.0321507 else 1.0
            totalValue += (asset.officialSpotPrice * multiplier * asset.weight * asset.amountHeld) + asset.premium
        }
...
fun WidgetContent(
    ...
    Column(
        ...
        Row(modifier = GlanceModifier.fillMaxWidth(), verticalAlignment = Alignment.Vertical.CenterVertically) {
            ...
            // --- ENLARGED REFRESH TARGET ---
            Box(
                modifier = GlanceModifier
                    .padding(4.dp) // Large hit box buffer
                ...
                Image(
                    ...
                    modifier = GlanceModifier.size(28.dp) // Icon increased from 20dp to 28dp
                )
            }
        }
