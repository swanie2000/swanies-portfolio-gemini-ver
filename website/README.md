...
2. **Screenshots** — **`website/images/01_sp_*.jpg`** … **`12_sp_*.jpg`** (JPEG). The **See the app in action** block on **`index.html`** is a **horizontal scroll** row; same files are suitable for **Play Console** phone screenshots (order 01→12 matches the page).
