...
**Last updated:** 2026-06-01 — **Live site:** **`app-showcase`** — video **left**, **stacked screenshot viewer** right (arrows / swipe, **no horizontal carousel**); **red Play + bar**, CTA idle/ended; scroll perf (**no header blur**, static bg). Owner verifying on **swaniedesigns.com** after deploy.
...
- **Marketing site (2026-06-01):** **`website/index.html`** — **`#get-app`**; **`#app-showcase`** / **`#app-demo`** — video left, **`#app-screenshots`** stacked viewer (**12** slides, arrows + swipe); **carousel removed** (scroll perf); **red Play + bar**; **no header blur** / static bg. Set **`PLAY_URL`** when listing live.
...
1. **Owner:** Verify **https://swaniedesigns.com** — side-by-side showcase, screenshot arrows/swipe, scroll over section, **`#get-app`**.
