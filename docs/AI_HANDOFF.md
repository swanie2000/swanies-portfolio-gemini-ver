...
- **2026-05-18 — Carousel video match + sound fix:** Video card **same phone size** as screenshots (`object-fit: contain` inside standard frame); robust unmute (`defaultMuted`, `volume=1`); louder web re-encode. **Push `main`**.
