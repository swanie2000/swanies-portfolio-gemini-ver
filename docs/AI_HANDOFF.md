...
**Last updated:** 2026-05-18 — **Play internal `18 (1.0.18)`** live. Repo **`19 (1.0.19)`** — Theme Manager scroll; **3** beta-unlock strings in all **19** locales. Wife Pro + RC lifetime OK. **Testers:** **4 / 12**.
...
| **Play internal testing** | **Active: 18 (1.0.18)** on Play; repo **`19 (1.0.19)`** — Theme Manager scroll + i18n beta-unlock strings. **Recruiting** (internal cap **100**). |
...
| **Version on device** | Play internal **`v1.0.18 (18)`**; repo **`v1.0.19 (19)`** — Theme Manager scroll + locale parity. |
...
1. **Play upload:** internal **`19 (1.0.19)`** — run **`verify-aab-revenuecat-key.ps1`** + **`verify-aab-beta-unlock-secret.ps1`** (both **OK**) → upload. Wife: verify Theme Manager scroll on tall phone.
...
| Play internal ship | **Studio** AAB → verify scripts; repo **`19` / `1.0.19`** ready to build/upload |
