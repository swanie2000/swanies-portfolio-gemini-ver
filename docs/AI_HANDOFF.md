...
- **Testing path:** **Closed Alpha 24** live; **Testers Community** submitted **2026-06-01** (1 Android credit). **≥12 opted-in for 14 consecutive days** → apply for **Production access** — watch **Dashboard** opted-in count. **License testing** **unchecked** for TC. **Site:** **`#get-app`** = internal invite QR only; closed opt-in **not** on site.
- **Testers Community form:** No shared login; install via closed link; create local account; Pro until **~July 2026** — do not purchase; feedback via **`contact.html?topic=tester`** or in-app **Settings → Send feedback**.
...
**Play / Google:** **Internal + Closed Alpha 24** live; **TC Day 0** (**2026-06-01**). **License testing** **unchecked**. **Production access:** closed-test window running — plan **25**/**26** + pre-launch + form (**§ Production access — Google requirements**). **Production** store build not shipped (**`GRANT_DAYS=0`** when it is).
...
4. Testers: opt in with Play Gmail; **Pro included until ~July 2026** — **do not purchase**; feedback URL + in-app feedback.
...
| **3. Production access form** | **~250–300+ characters per answer** on **10 questions**; accurate, app-specific | Mention **Testers Community** (paid), **Google Group** `testers-community@googlegroups.com`, closed opt-in link, **Web3Forms** + **`contact.html?topic=tester`**, in-app **Settings → Send feedback**, **build numbers** and **what changed**. **Do not** copy chess-app or other generic templates verbatim. |
| **Engagement** | Testers actually use the app | TC + Play feedback; owner saves anonymized feedback summaries for the form. Rejection emails sometimes cite “not engaged” even when devs disagree — **releases + form depth** are the lever. |
...
5. **Production release:** **`GRANT_DAYS=0`** → **`verify-play-release.ps1`** → staged rollout.
