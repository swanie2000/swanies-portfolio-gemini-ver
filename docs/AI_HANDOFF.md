...
**Last updated:** 2026-05-18 — **Play internal `20 (1.0.20)`** live. Repo **`21 (1.0.21)`** — multi-widget blank fix (per-portfolio push targeting). Owner uploading **21** for website video / multi-widget QA. **Testers:** **4 / 12**.
...
| **Play internal testing** | **Active: 20 (1.0.20)** on Play; repo **`21 (1.0.21)`** — multi-widget blank fix. Owner uploading **21**. **Recruiting** (internal cap **100**). |
| **Version on device** | Play internal **`v1.0.20 (20)`** until **21** rolls out; repo **`v1.0.21 (21)`**. |
...
- **Testing path:** **Internal testing** **21 (1.0.21)** pending upload — **4 testers** (need **≥12** for closed track). Recruit: **`docs/RECRUIT_INTERNAL_TESTERS.md`** + **`#join-testing`**.
...
1. **Play upload:** internal **`21 (1.0.21)`** — verify scripts **OK** → upload. QA: **3 widgets** on **3 portfolios**; refresh one — others stay populated.
2. **Recruit testers (4 → 12):** **`docs/RECRUIT_INTERNAL_TESTERS.md`**
3. **Closed testing (agent when ≥12 internal):** Promote build to closed.
4. **Listing / Production** after closed gates + Dashboard clear.
